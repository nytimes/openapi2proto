...
func _main() error {
	...
	goPackageOption := flag.String("go-pkg", "", "the Go package to add as an option to the generated proto")
	flag.Parse()
	...
	encoderOptions = append(encoderOptions, protobuf.WithGoPackageOption(*goPackageOption))
